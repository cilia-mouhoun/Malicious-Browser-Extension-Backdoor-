/**
 * ============================================================================
 * TypeSmart — Shared Constants (constants.js)
 * ============================================================================
 *
 * PURPOSE:
 *   Single source of truth for every magic string, numeric threshold, and
 *   message type used across the extension.  Import this file instead of
 *   hard-coding values — it keeps all modules in sync and makes future
 *   changes trivial.
 *
 * USAGE:
 *   • ES module:       import { STORAGE_KEY, MSG_TYPES, ... } from './constants.js';
 *   • Content script:  access via window.TSConstants global.
 *   • Background page: <script src="shared/constants.js"></script>
 *
